...
jne final
; verificam al treilea patrat 
check_cul_patrat button_x+163, button_y+243, cul
cmp eax, 1
jne final
mov edx, 1
jmp final_final
...
sterge_cul macro cul ;verifica patratele in ordine si primul patrat colorat in albastru il sterge
...
;patrat1
	...
	je check_patrat3
		;patrat este egal -- 2
		patrat_v button_x+240, button_y, button_size, 0EEB587h
		jmp final
	...
	je check_patrat6
		;patrat este egal -- 3
		patrat_v button_x+480, button_y, button_size, 0EEB587h
		jmp final
	...
	je check_patrat5
		...
		;patrat este egal -- 4
		patrat_v button_x+80, button_y+80, button_size, 0EEB587h
		jmp final
	...
	je check_patrat8
		;patrat este egal -- 5
		patrat_v button_x+240, button_y+80, button_size, 0EEB587h
		jmp final
	...
	je check_patrat7
		;patrat este egal -- 6
		patrat_v button_x+400, button_y+80, button_size, 0EEB587h
		jmp final
	...
	je check_patrat9
		;patrat este egal -- 7
		patrat_v button_x+160, button_y+160, button_size, 0EEB587h
		jmp final
	...
	je check_patrat9
		;patrat este egal -- 8
		patrat_v button_x+240, button_y+160, button_size, 0EEB587h
		jmp final
	...
	je check_patrat15
		...
		;patrat este egal -- 9
		patrat_v button_x+320, button_y+160, button_size,0EEB587h
		jmp final
	...
	je check_patrat11
		;patrat este egal -- 10
		patrat_v button_x, button_y+240, button_size, 0EEB587h
		jmp final
	...
	je check_patrat14
		;patrat este egal -- 11
		patrat_v button_x+80, button_y+240, button_size, 0EEB587h
		jmp final
	...
	je check_patrat13
		;patrat este egal -- 12
		patrat_v button_x+160, button_y+240, button_size, 0EEB587h
		jmp final
	...
	je check_patrat16
		;patrat este egal -- 13
		patrat_v button_x+320, button_y+240, button_size, 0EEB587h
		jmp final
	...
	je check_patrat15
		;patrat este egal -- 14
		patrat_v button_x+400, button_y+240, button_size, 0EEB587h
		jmp final
	...
	check_patrat15:
	    ...
	    je check_patrat17
		;patrat este egal -- 15
		patrat_v button_x+480, button_y+240, button_size,0EEB587h
		jmp final
	...
	je check_patrat17
		;patrat este egal -- 16
		patrat_v button_x+160, button_y+320, button_size,0EEB587h
		jmp final
	check_patrat17:
			check_cul_patrat button_x+243, button_y+323, cul
		cmp eax, 1
	...
	je check_patrat20
		;patrat este egal -- 17
		patrat_v button_x+240, button_y+320, button_size, 0EEB587h
		jmp final
	...
	je check_patrat19
		;patrat este egal -- 18
		patrat_v button_x+320, button_y+320, button_size, 0EEB587h
		jmp final
	...
	je check_patrat22
		;patrat este egal -- 19
		patrat_v button_x+80, button_y+400, button_size, 0EEB587h
		jmp final
	...
	je check_patrat21
		;patrat este egal -- 20
		patrat_v button_x+240, button_y+400, button_size, 0EEB587h
		jmp final
	...
	je check_patrat24
		;patrat este egal -- 21
		patrat_v button_x+400, button_y+400, button_size,0EEB587h
		jmp final
	...
	je check_patrat23
		;patrat este egal -- 22
		patrat_v button_x, button_y+480, button_size, 0EEB587h
		jmp final
	check_patrat23:
			check_cul_patrat button_x+243, button_y+483, cul
		cmp eax, 1
	...
	je final
		;patrat este egal -- 23
		patrat_v button_x+240, button_y+480, button_size,0EEB587h
		jmp final
	check_patrat24:
			check_cul_patrat button_x+483, button_y+483, cul
		cmp eax, 1
	...
	je final
		;patrat este egal -- 24
		patrat_v button_x+480, button_y+480, button_size,0EEB587h
